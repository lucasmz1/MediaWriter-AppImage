...
install=$(pacman -S file binutils patchelf findutils grep sed coreutils strace --noconfirm)
export ARCH VERSION
export DEPLOY_QT=1
export OUTPATH=./dist
...
# Deploy dependencies
quick-sharun /usr/bin/mediawriter /usr/lib/mediawriter /usr/lib/qt6/qml /usr/lib/qt6/plugins
